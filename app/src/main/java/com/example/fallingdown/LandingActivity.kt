...
class LandingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val loginBtn = findViewById<Button>(R.id.btn_login).setOnClickListener {
            val account = findViewById<EditText>(R.id.edit_account).text.toString()
            val password = findViewById<EditText>(R.id.edit_password).text.toString()
            val payload = LoginRequestModel(account, password)
        ...
        loginBottomSheet.view.findViewById<Button>(R.id.btn_sign_up).setOnClickListener {
